...
# SECRET_KEY = 'django-insecure-232ocgxhv$u%%j@b_=)krzaq9t!(%m6aqe@o4n2=%z5eumgdqj'
...
ALLOWED_HOSTS = os.getenv("myblog-x-001.onrender.com", "localhost").split(",")

SECRET_KEY = os.getenv("xxxMatrix", "unsafe-secret-key")
